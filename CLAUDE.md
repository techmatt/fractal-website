...
node --test explorer/permalink.test.mjs explorer/bands.test.mjs atlas/atlas.test.mjs
```

The second line is the three JavaScript suites, on Node's own runner with nothing
...
is the only reason a dot's picture and a dot's link agree.
