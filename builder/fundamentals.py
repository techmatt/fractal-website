...
CYCLIC_PROVENANCE = (
    ...
    "0daf678f61143941, seat 336 of the recorded tentative gallery 20260902T161757Z: the "
    "location as it ships, addressed by its own key rather than by a position in anything. "
    "The **map is this figure's own** and not that seat's *(Matt, 2026-09-02)*: "
    f"{CYCLIC_MAP}, an authored map, replacing the extracted nova-25 the seat ships with. "
