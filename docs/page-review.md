...
| `fractal-atlases.html` | Fractal atlases v1 | 0 | 0 | 0 | yes, with v1 |
...
its line and link. The slot pictures are staged, so until deploy the served frame shows
