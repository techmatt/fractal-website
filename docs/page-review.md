...
| `deep-zoom.html` | yes | `Deep zoom v2.md` | applied 2026-09-23, review doc | 7 placeholders | **v2 placed 2026-09-23** (PLACE_deep_zoom_v2_ckpt144), Matt's review of v1 applied by the design session; the fresh review doc is waiting in `review\`. Every figure is a `figure-placeholder` with its draft caption and no registry row, so `grep -rn figure-placeholder` is the figure round's list |
...
| `deep-zoom.html` | Deep zoom v2 | 0 | 0 | 0 | yes, with v2 |
